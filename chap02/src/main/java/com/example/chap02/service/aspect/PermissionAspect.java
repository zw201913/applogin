package com.example.chap02.service.aspect;
...
import com.example.chap02.model.User;
import com.example.chap02.service.LoginService;

@Component
@Aspect
public class PermissionAspect {
	
	@Before("@annotation(com.example.chap02.annotation.UserAccess)")
